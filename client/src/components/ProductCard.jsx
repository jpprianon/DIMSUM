...
import { StarIcon, starIcon } from "@chakra-ui/icons";
  ...
  return (
    <Flex>
      ...
      <Text fontSize="md" fontWeight="bold" ml="4px">
        {`${numReviews} ${numReviews === 1 ? "Note" : "Notes"}`}
      </Text>
    </Flex>
  );
};
    ...
    >
      ...
      <Flex justify="space-between">
        ...
        <Tooltip
          ...
          fontSize="1.2em"
        >
          <Button variant="ghost" display="fleex" disabled={product.stock <= 0}>
            <Icon as={FiShoppingCart} h={7} alignSelf="center" />
          </Button>
        </Tooltip>
      </Flex>
    </Stack>
